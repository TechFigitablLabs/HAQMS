...
// GET /api/patients/:id/history-records
// Get patient details and paginated appointments with doctor info
router.get('/:id/history-records', authenticate, async (req, res) => {
  try {
    const { id } = req.params;
    const page = parseInt(req.query.page) || 1;
