...
// FIXED: Previously had N+1 query issue — now uses Prisma include to resolve
// patient and doctor relations in a single query.
router.get("/", authenticate, async (req, res) => {
  try {
    ...
    // Fetch appointments with related patient and doctor in a single query (no N+1)
