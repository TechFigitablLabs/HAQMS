...
// FIX: API base URL is now read from an environment variable (set in .env.local)
// instead of being hardcoded. This makes it trivial to point to staging/production
